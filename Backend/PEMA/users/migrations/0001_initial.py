    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, help_text="User's unique username", max_length=30, validators=[django.core.validators.RegexValidator(message='Username can only contain letters, numbers, underscores, or hyphens.', regex='^[\\w-]+$')], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, help_text="User's profile picture.", null=True, upload_to=users.utils.get_unique_profile_pic_path)),
